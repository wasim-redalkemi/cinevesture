...
{	
    ...
    Route::group(['prefix'=>'user-management'],function()
    {
        ...
        Route::get('/user-plan-edit/{id}', [AdminUserController::class, 'editPlan'])->name('user-plan');
        Route::post('/user-plan', [AdminUserController::class, 'planUpdate'])->name('user-plan-update');
