...
Route::group(["middleware" => ["auth", "revalidate", "verified",'is_admin']], function () {
    ...
    Route::group(['prefix' => 'project'], function () {
        ...
        Route::post('/validate-project-overview', [ProjectController::class, 'validateProjectOverview'])->name('validate-project-overview')->middleware('plancheck');

        Route::get('/project-details', [ProjectController::class, 'projectDetails'])->name('project-details')->middleware('plancheck');
        ...
        Route::post('/validate-project-description', [ProjectController::class, 'validateProjectDescription'])->name('validate-project-description')->middleware('plancheck');


        Route::get('/project-gallery', [ProjectController::class, 'projectGallery'])->name('project-gallery')->middleware('plancheck');
        Route::post('/project-gallery-store', [ProjectController::class, 'galleryStore'])->name('project-gallery-store')->middleware('plancheck');

        Route::get('/project-milestone', [ProjectController::class, 'projectMilestone'])->name('project-milestone')->middleware('plancheck');
        Route::post('/validate-project-milestone', [ProjectController::class, 'validateProjectMilestone'])->name('validate-project-milestone');

        Route::get('/project-preview', [ProjectController::class, 'projectPreview'])->name('project-preview')->middleware('plancheck');
