              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="list d-flex align-items-center border-bottom pb-3">
                    <img class="img-sm rounded-circle" src="images/face8.jpg" alt="">
                  ...
                  <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="images/face5.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
                  ...
                  <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="images/face7.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
                  ...
                  <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="images/face6.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
                  ...
                  <div class="list d-flex align-items-center pt-3">
                    <img class="img-sm rounded-circle" src="images/face9.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="wrapper d-flex align-items-center justify-content-start justify-content-sm-center flex-wrap">
                    <img class="img-md rounded" src="images/face1.jpg" alt="">
            ...
            <div class="col-md-4 grid-margin grid-margin-md-0">
              <div class="card">
                <div class="card-body">
                  <div class="wrapper d-flex align-items-center justify-content-start justify-content-sm-center flex-wrap">
                    <img class="img-md rounded" src="images/face2.jpg" alt="">
                    <div class="wrapper ml-4">
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body">
                  <div class="wrapper d-flex align-items-center justify-content-start justify-content-sm-center flex-wrap">
                    <img class="img-md rounded" src="images/face3.jpg" alt="">
                    <div class="wrapper ml-4">
