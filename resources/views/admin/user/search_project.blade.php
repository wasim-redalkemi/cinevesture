...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                   <form role="form" method="Post" action="{{ route('find-project',['id' => $id ]) }}" >
                            @csrf
                            <div class="row">
                              <div class="col-md-12">
                            ...
                            <div class="col-md-6 font-weight-bold"><div style="text-align:center ;">Name</div></div>
                            <div class="col-md-4 font-weight-bold"><div>Finance Secured</div></div>
                            <div class="col-md-4 font-weight-bold"><div>Recommended Badge</div></div>
                            <div class="col-md-4 font-weight-bold"><div>Image</div></div>
                            <div class="col-md-2 font-weight-bold"><div style="text-align: center;">Select</div></div>
                            </div>
                              </div> -->
