                                    ...
                                    <?php echo $i;?>
                                       ...
                                       <td>
                                        ...
                                        <a class="confirmAction" href="{{route('delete-list',['id' =>$project->id ])}}">
                                            <button class="btn btn-danger btn-fw mb-1 @if($project->list_name=="carousel") d-none @endif  btn-sm mt-10 w-60 view-btn btn_padding col-md-4" type="button" >Delete</button>
                                        </a>
                                       </td>
                                    </tr>
                                @endforeach
