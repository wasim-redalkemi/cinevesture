            ...
            <div class="row mt-4">
                <div class="col-md-8">
                    <div>
                       ...
                       <div class="form_elem"> <textarea class="radius form-control text_editor" type="text-field" style="height: 150px;" value="{{$query->message}}" name="" id="editor" disabled>{{$query->message}}</textarea></div>
