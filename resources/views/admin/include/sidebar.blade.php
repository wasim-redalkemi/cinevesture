        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="proj-mgt">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item" >
                <a class="nav-link" href="{{route('show-list')}}">List</a>
              </li>
               <li class="nav-item">
                <a class="nav-link" href="{{route('project-list-management')}}">Create</a>
              </li> 
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="editors">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="{{route('user_order')}}">Text editors</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#tables" aria-expanded="false" aria-controls="tables">
              <i class="fa fa-table" style="margin-right:25px;"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/ui-features/notifications.html">
              <i class="fa fa-bell" style="margin-right:25px;"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#maps" aria-expanded="false" aria-controls="maps">
              <i class="fa fa-map" style="margin-right:25px;"></i>
