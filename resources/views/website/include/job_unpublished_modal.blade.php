<div class="modal fade" id="jobUnpublishedActionModal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div class="col-md-12">
                            <div class="modal_container">
                                ...
                                <div class="d-flex justify-content-center mt-4">   
                                    ...
                                    <a href="" class="jobUnpublishedActionModalLink"><button class="delete_btn confirm_btn_text mx-3" type="button" data-bs-dismiss="modal">Confirm</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
