...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header">
    <!-- <h5 class="offcanvas-title" id="offcanvasExampleLabel">Cinevesture</h5> -->
    <button type="button" class="btn-close text-white" data-bs-dismiss="offcanvas" aria-label="Close"><img src="{{ asset('images/asset/crossicon.png') }}" width="35" alt="image"></button>
  </div>
  ...
  <div>
            ...
            <div class="d-flex justify-content-center">
              ...
              <!-- <div class="d--flex"> -->
                <button type="submit" class="header-search-btn ml_10 mt-3 mr_5">Search</button>
                <a href="{{ route('project-overview')}}">
                  <button type="button" class="add-proj-btn my-2 my-sm-0 mr-0 d-none d-md-block text-white">
                      Add a Project
                  </button>
