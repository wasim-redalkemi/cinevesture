                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="profile_input">
                                        ...
                                        <div class="form_elem">
                                        <textarea class="form-control controlTextLength text_editor @error('description') is-invalid @enderror" text-length = "250"  name="description" aria-label="With textarea"  required>{{ $UserQualificationData->description }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
