                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="profile_input">
                                        ...
                                        <div class="form_elem">
                                        <textarea class="form-control text_editor controlTextLength @error('description') is-invalid @enderror" text-length = "1000" maxlength="1000" name="description" aria-label="With textarea"  required></textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between justify-content-md-end flex-wrap mt-4">
                                        ...
                                        <button type="submit" name="saveAndNext" value="false" class="portfolio_save_btn_next guide_profile_btn mx-3">Save</button>
...
<script>
    ...
    $(".portfolio_save_btn_next").on("click", function () {
        $("#save_and_next").attr("value", $(this).attr("name"))
        $(this).parents('form').submit();
    });
</script>
@endpush
