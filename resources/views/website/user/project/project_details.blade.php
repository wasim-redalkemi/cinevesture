                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="profile_input select2forError">
                                    ...
                                    <select name="category_id[]" id="leadadd_mode_of_enq" name="leadadd_mode_of_enq" class="js-select2 @error('category_id') is-invalid @enderror" autofocus multiple required>
