                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="profile_input">
                                    ...
                                    <div class="form_elem">
                                        <textarea class="form-control controlTextLength text_editor1" placeholder="Write Synopsis" text-length = "790" maxlength="790" name="synopsis" aria-label="With textarea" required>@if (!empty($projectDescription[0]->synopsis)){{ $projectDescription[0]->synopsis }}@endif</textarea>
                                        @error('synopsis')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
