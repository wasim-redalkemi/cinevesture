                    ...
                    <form role="form" class="validateBeforeSubmit" method="POST" enctype="multipart/form-data" action="{{route('validate-project-description')}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form_elem">
                                    <textarea class="form-control controlTextLength text_editor2 " text-length = "250" maxlength="250" placeholder="Write Logline" name="logline" aria-label="With textarea" style="border: 1px solid #4D0D8A;" rows="1" required>@if (!empty($projectDescription[0]->logline)){{ $projectDescription[0]->logline }}@endif</textarea>
                                    @error('Logline')
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="profile_input">
                                    ...
                                    <div class="form_elem">
                                        <textarea class="form-control controlTextLength text_editor1" placeholder="Write Synopsis" text-length = "790" maxlength="790" name="synopsis" aria-label="With textarea" required>@if (!empty($projectDescription[0]->synopsis))@php
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <div class="form_elem">
                                    <textarea class="form-control controlTextLength text_editor" placeholder="Write Statement" text-length = "1300" maxlength="1300" name="director_statement" style="border: 1px solid #4D0D8A;" id="textAreaExample3" rows="1" required>@if (!empty($projectDescription[0]->director_statement)){{ $projectDescription[0]->director_statement }}@endif</textarea>
