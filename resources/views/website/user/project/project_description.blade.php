                    ...
                    <form role="form" class="validateBeforeSubmit" method="POST" enctype="multipart/form-data" action="{{route('validate-project-description')}}">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="profile_input">
                                    ...
                                    <div class="form_elem">
                                        <textarea class="form-control controlTextLength" placeholder="Write Synopsis" text-length = "790" maxlength="790" name="synopsis" aria-label="With textarea" required>@if (!empty($projectDescription[0]->synopsis)){{ $projectDescription[0]->synopsis }}@endif</textarea>
                                        @error('synopsis')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <div class="form_elem">
                                    <textarea class="form-control controlTextLength" placeholder="Write Statement" text-length = "1300" maxlength="1300" name="director_statement" style="border: 1px solid #4D0D8A;" id="textAreaExample3" rows="1" required>@if (!empty($projectDescription[0]->director_statement)){{ $projectDescription[0]->director_statement }}@endif</textarea>
