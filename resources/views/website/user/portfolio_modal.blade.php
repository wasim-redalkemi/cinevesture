<div class="mt-2 sign_now_text text_user_name">@if (!empty($data['project_title'])) {{ $data['project_title']}} @endif</div>
...
<span><b>-</b></span>
@endif
<div class="mt-2 guide_profile_main_subtext">@if (!empty($data['description'])) {{ $data['description']}} @endif</div>
<div class="search-head-subtext deep-pink">@if (!empty($data['video'])) {{ $data['video']}} @endif</div>
