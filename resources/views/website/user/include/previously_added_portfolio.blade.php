                                ...
                                ?>
                                  <div class="previous_data_card_wrap_elem">
                                    <div class="card previous_data_card">
                                      ...
                                      <div class="mt-2">
                                        <div class="upload_resume_text d-flex">
                                          @if(isset($v->getPortfolioSkill[0]))
                                              <button class="curv_cmn_btn">{{$v->getPortfolioSkill[0]->name}}</button>
                                          @endif

                                          @if(isset($v->getPortfolioSkill) && count($v->getPortfolioSkill)>1)
                                              <button class="curv_cmn_btn"><b>+{{(count($v->getPortfolioSkill)-1)}}</b></button>
                                          @endif
                                        </div>
