                    ...
                    <form class="validateBeforeSubmit" onsubmit="return false;" id="post_job" >
                        ...
                        <div class="guide_profile_subsection pb-4">
                            ...
                            <div class="profile_input form_elem">
                                <textarea class="form-control controlTextLength text_editor" text-length="500" id="description" name="description" required aria-label="With textarea" placeholder="Your answer here">@if (!empty($userJobData['description'])) {{$userJobData['description']}} @endif</textarea>
                            </div>
                        </div>
                        <div class="guide_profile_subsection">
                            ...
                            <div class="col-md-12">
                                <div class="modal_container">
                                    ...
                                    <div class="successfullPublish_text sub_text mt-4">
                                        You have successfully published a Job. Do you want to promote your job?
