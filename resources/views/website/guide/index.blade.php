            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="industry_sub_text mt-3 px-2">It is our job to make your search for people in the film and media fraternity, a piece of cake! <br>
                            <div class="mt-2 mt-md-0">Here's your slice.</div>
                        </div>
                        <form class="" method="Get" action="{{ route('guide-view') }}">
                            @csrf
                            <div class="input_wraper py-4 py-md-5 mt-3">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-3">
