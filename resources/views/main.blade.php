      ...
      <div class="sub-section">
        <div class="main_slider owl-carousel">
          ...
          <div class="item">
            <div class="home-upper-slider">
              <div class="img-container w_maxcont">
                <img src="{{ asset('images/asset/Screenshot 2021-05-28 at 11.48 1.png') }}"  height="100%" alt="image">
              </div>
          ...
          <div class="item">
            <div class="home-upper-slider">
              <div class="img-container w_maxcont">
                <img src="{{ asset('images/asset/Screenshot 2021-05-28 at 11.48 1.png') }}" height="100%" width="100%" alt="image">
              </div>
              <div class="carosel-card-cntainer">
                <div class="container">
                  <div class="row">
      ...
      <div class="home_subsection pb-5">
        ...
        <div class="test owl-carousel owl-theme">
          <div class="home_img_wrap">
            <div class="slider">
              <div class="img-container">
                <img src="{{ asset('images/asset/ba947a848086b8f90238636dcf7efdb5 1.png') }}" width="370" height="240" alt="image">
              </div>
            </div>
          </div>
          <div class="home_img_wrap">
          ...
          <div class="home_img_wrap">
            <img src="{{ asset('images/asset/Rectangle 42.png') }}" alt="image">
          </div>
          <div class="home_img_wrap">
            <img src="{{ asset('images/asset/download (3) 2.png') }}"  alt="image">
          </div>
          <div class="home_img_wrap">
            <img src="{{ asset('images/asset/gordon-cowie-OPlXmibx__I-unsplash 1.png') }}" alt="image">
          </div>
        </div>
      </div>
    </section>
