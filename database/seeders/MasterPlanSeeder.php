    ...
    public function run()
    {
        ...
        $query = "INSERT INTO `plans`
            (`id`,
             ...
             `plan_time_quntity`,
             `status`)
             values('1', 'stripe','1','Free','USD','0.00','non-recurring','m','0','1','active'),
                   ('2', 'stripe','1','Free','INR','0.00','non-recurring','m','0','1','active'),
                   ('3', 'stripe','1','Free','INR','0.00','non-recurring','y','0','1','active'),
                   ('4', 'stripe','1','Free','USD','0.00','non-recurring','y','0','1','active'),
